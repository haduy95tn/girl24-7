...
$sql    = "SELECT * FROM khv_thainguyen WHERE (approval = 'Pending' AND DateTime BETWEEN '".$_GET['dbdate']." 00:00:00"."' AND '".$_GET['dbdate']." 23:59:59') OR (approval = 'Pending' AND Part = '".$_GET['browser']."') ";
...
<body>
        <div id="logo">
            <a href="approval.php"> <img src="image/KHVATEC.png" alt=""></a>
        </div> 
            <div id="search">
            <form action="date_approval.php" method="GET">
                <h3>Select Date</h3>
                <input type="date" name="dbdate" value="dbdate"><br>
