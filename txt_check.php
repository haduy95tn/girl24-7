...
$sql    = "SELECT * FROM khv_thainguyen WHERE (time_out >'0' AND Username = '".$_GET['txtcheck']."') OR (time_out >'0' AND Company = '".$_GET['txtcheck']."') OR (time_out > '0' AND Part = '".$_GET['browser']."') " ;
...
<body>
    ...
    <div id="search">
    	<form action="date_checkdata.php" method="GET">
    		<h3>Select Date</h3>
    		<input type="date" name="dbdate1" value="dbdate">
    		<input type="date" name="dbdate2" value="dbdate">
    		<input type="submit">
    	</form>
